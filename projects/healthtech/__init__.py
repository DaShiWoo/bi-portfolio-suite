...
def render() -> None:
    ...
    with tabs[0]:
        page1_icu.render(df_f)
    with tabs[1]:
        page2_vitals.render(df_f)
    with tabs[2]:
        page3_survival.render(df_f)
    with tabs[3]:
        page4_risk.render(df_f)
    with tabs[4]:
        page5_cohorts.render(df_f)
